...
namespace SigningToday.Test
{
    ...
    public class Bit4idPathgroupSignatureTransactionsApiTests
    {
        ...
        public void CancelDSTTest()
        {
            ...
            //var response = instance.CancelDST(organizationId, dstId, inlineObject1);
        ...
        public void ListDSTsTest()
        {
            ...
            //int page = null;
            //int count = null;
            //var response = instance.ListDSTs(organizationId, whereSigner, whereStatus, whereTitle, whereCreatedBy, whereCreated, whereSignatureStatus, whereDocumentName, whereReason, whereSignatureName, whereSignerGroup, page, count);
