...
namespace SigningToday.Test
{
    ...
    public class Bit4idPathgroupIdentitiesApiTests
    {
        ...
        public void GetIdentityTest()
        {
            ...
            //string organizationId = null;
            //Id identityId = null;
            //var response = instance.GetIdentity(organizationId, identityId);
        ...
        public void ListEnrollmentRequestsTest()
        {
            ...
            //int page = null;
            //int count = null;
            //var response = instance.ListEnrollmentRequests(organizationId, whereProvider, whereUser, whereFirstName, whereLastName, whereRegisteredBy, whereFiscalCode, page, count);
        ...
        public void ListIdentitiesTest()
        {
            ...
            //int page = null;
            //int count = null;
            //var response = instance.ListIdentities(organizationId, whereProvider, whereUser, whereFirstName, whereLastName, whereRegisteredBy, whereFiscalCode, page, count);
        ...
        public void ListUserEnrollmentsTest()
        {
            ...
            //int page = null;
            //int count = null;
            //var response = instance.ListUserEnrollments(organizationId, userId, page, count);
            //Assert.IsInstanceOf(typeof(InlineResponse2005), response, "response is InlineResponse2005");
        }
        ...
        public void ListUserIdentitiesTest()
        {
            ...
            //int page = null;
            //int count = null;
            //var response = instance.ListUserIdentities(organizationId, userId, page, count);
            //Assert.IsInstanceOf(typeof(InlineResponse2001), response, "response is InlineResponse2001");
        }
