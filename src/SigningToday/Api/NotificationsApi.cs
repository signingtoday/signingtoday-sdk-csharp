...
namespace SigningToday.Api
{
    ...
    public partial class NotificationsApi : INotificationsApi
    {
        ...
        /// <returns></returns>
        public NotificationsApi(SigningToday.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> NotificationsDstIdDeleteWithHttpInfo (Guid id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling NotificationsApi->NotificationsDstIdDelete");
        ...
        public ApiResponse<Object> NotificationsPushTokenDeleteWithHttpInfo (string deviceId)
        {
            ...
            if (deviceId == null)
                throw new ApiException(400, "Missing required parameter 'deviceId' when calling NotificationsApi->NotificationsPushTokenDelete");
        ...
        public ApiResponse<Object> NotificationsPushTokenPostWithHttpInfo (InlineObject6 inlineObject6)
        {
            ...
            if (inlineObject6 == null)
                throw new ApiException(400, "Missing required parameter 'inlineObject6' when calling NotificationsApi->NotificationsPushTokenPost");
