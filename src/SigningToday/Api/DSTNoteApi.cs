...
namespace SigningToday.Api
{
    ...
    /// </summary>
    public interface IDSTNoteApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DSTNoteApi : IDSTNoteApi
    {
        private SigningToday.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DSTNoteApi"/> class.
        /// </summary>
        /// <returns></returns>
        public DSTNoteApi(String basePath)
        {
        ...
        /// <returns></returns>
        public DSTNoteApi(SigningToday.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<List<DSTNote>> DSTIdNoteGetWithHttpInfo (Guid id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling DSTNoteApi->DSTIdNoteGet");
        ...
        public ApiResponse<Object> DSTIdNoteNoteIdDeleteWithHttpInfo (Guid id, long noteId)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling DSTNoteApi->DSTIdNoteNoteIdDelete");
            // verify the required parameter 'noteId' is set
            if (noteId == null)
                throw new ApiException(400, "Missing required parameter 'noteId' when calling DSTNoteApi->DSTIdNoteNoteIdDelete");
        ...
        public ApiResponse<DSTNote> DSTIdNoteNoteIdPutWithHttpInfo (Guid id, long noteId, DSTNote dSTNote)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling DSTNoteApi->DSTIdNoteNoteIdPut");
            // verify the required parameter 'noteId' is set
            if (noteId == null)
                throw new ApiException(400, "Missing required parameter 'noteId' when calling DSTNoteApi->DSTIdNoteNoteIdPut");
            // verify the required parameter 'dSTNote' is set
            if (dSTNote == null)
                throw new ApiException(400, "Missing required parameter 'dSTNote' when calling DSTNoteApi->DSTIdNoteNoteIdPut");
        ...
        public ApiResponse<DSTNote> DSTIdNotePostWithHttpInfo (Guid id, InlineObject1 inlineObject1 = default(InlineObject1))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling DSTNoteApi->DSTIdNotePost");
