...
namespace SigningToday.Api
{
    ...
    /// </summary>
    public interface IBit4idPathgroupOrganizationsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Bit4idPathgroupOrganizationsApi : IBit4idPathgroupOrganizationsApi
    {
        private SigningToday.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="Bit4idPathgroupOrganizationsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public Bit4idPathgroupOrganizationsApi(String basePath)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Bit4idPathgroupOrganizationsApi()
        {
        ...
        /// <returns></returns>
        public Bit4idPathgroupOrganizationsApi(SigningToday.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Get the settings of an oraganization This API allows to obtain the settings of an organization, such as:   - _default_rao_ : the default rao user of the organization   - _dst_default_months_ : default deadline of a dst before its expiration   - _logo_ : the logo of the organization 
        /// </summary>
        /// <exception cref="SigningToday.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="organizationId">The **organization-id** represents an organization that is included in the SigninToday application, also know as **slug** and it is used as a path parameter to restrict the asked functionality to the specified organization </param>
        /// <returns>InlineResponse200</returns>
        ...
        public ApiResponse<InlineResponse200> GetOrganizationWithHttpInfo (string organizationId)
        {
            ...
            if (organizationId == null)
                throw new ApiException(400, "Missing required parameter 'organizationId' when calling Bit4idPathgroupOrganizationsApi->GetOrganization");
        ...
        public ApiResponse<InlineResponse200> PatchOrganizationWithHttpInfo (string organizationId, UpdateOrganization updateOrganization)
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
                throw new ApiException(400, "Missing required parameter 'organizationId' when calling Bit4idPathgroupOrganizationsApi->PatchOrganization");
            // verify the required parameter 'updateOrganization' is set
            if (updateOrganization == null)
                throw new ApiException(400, "Missing required parameter 'updateOrganization' when calling Bit4idPathgroupOrganizationsApi->PatchOrganization");
