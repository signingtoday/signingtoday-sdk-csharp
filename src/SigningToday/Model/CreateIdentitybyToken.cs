...
namespace SigningToday.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateIdentitybyToken :  IEquatable<CreateIdentitybyToken>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateIdentitybyToken" /> class.
        /// </summary>
        /// <param name="certificate">The X.509 certificate in PEM format is wanted to associate to the identity will be created.</param>
        /// <param name="data">The data associated to the identity, analogue to the _provider_data_ field used during traditional identity creation. Of course the _provider_data_ has to be congruent with the choosen cerficate .</param>
        ...
        public CreateIdentitybyToken(string certificate = default(string), Object data = default(Object), string label = default(string))
        {
        ...
        /// </summary>
        /// <value>The X.509 certificate in PEM format is wanted to associate to the identity will be created</value>
        [DataMember(Name="certificate", EmitDefaultValue=false)]
        public string Certificate { get; set; }

        /// <summary>
        /// The data associated to the identity, analogue to the _provider_data_ field used during traditional identity creation. Of course the _provider_data_ has to be congruent with the choosen cerficate 
        /// </summary>
        /// <value>The data associated to the identity, analogue to the _provider_data_ field used during traditional identity creation. Of course the _provider_data_ has to be congruent with the choosen cerficate </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateIdentitybyToken {\n");
        ...
        {
            return this.Equals(input as CreateIdentitybyToken);
        }

        /// <summary>
        /// Returns true if CreateIdentitybyToken instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateIdentitybyToken to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateIdentitybyToken input)
        {
            if (input == null)
                return false;
