...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(PaginationData pagination = default(PaginationData), MetaDataSuccess meta = default(MetaDataSuccess), List<IdentityEnroll> data = default(List<IdentityEnroll>))
        {
