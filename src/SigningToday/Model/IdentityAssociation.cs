...
namespace SigningToday.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IdentityAssociation :  IEquatable<IdentityAssociation>, IValidatableObject
    {
        /// <summary>
        ...
        public enum ProviderIdEnum
        {
            ...
            /// <summary>
            /// Enum ArubaAuto for value: aruba-auto
            /// </summary>
            [EnumMember(Value = "aruba-auto")]
            ArubaAuto = 2,

            /// <summary>
            /// Enum Infocert for value: infocert
            /// </summary>
            [EnumMember(Value = "infocert")]
            Infocert = 3,

            /// <summary>
            /// Enum Namirial for value: namirial
            /// </summary>
            [EnumMember(Value = "namirial")]
            Namirial = 4
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityAssociation" /> class.
        /// </summary>
        ...
        public IdentityAssociation(string label = default(string), Object providerData = default(Object), ProviderIdEnum? providerId = default(ProviderIdEnum?))
        {
            this.Label = label;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityAssociation {\n");
        ...
        {
            return this.Equals(input as IdentityAssociation);
        }

        /// <summary>
        /// Returns true if IdentityAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityAssociation input)
        {
            if (input == null)
                return false;
