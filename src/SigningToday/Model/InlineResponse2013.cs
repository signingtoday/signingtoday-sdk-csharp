...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse2013 :  IEquatable<InlineResponse2013>, IValidatableObject
    {
        ...
        public InlineResponse2013(SignatureTransaction data = default(SignatureTransaction), MetaDataSuccess meta = default(MetaDataSuccess))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public SignatureTransaction Data { get; set; }
