...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse20011 :  IEquatable<InlineResponse20011>, IValidatableObject
    {
        ...
        public InlineResponse20011(List<Token> data = default(List<Token>), MetaDataSuccess meta = default(MetaDataSuccess), PaginationData pagination = default(PaginationData))
        {
            this.Data = data;
            this.Meta = meta;
