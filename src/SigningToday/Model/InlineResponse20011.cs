...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse20011 :  IEquatable<InlineResponse20011>, IValidatableObject
    {
        ...
        public InlineResponse20011(MetaDataSuccess meta = default(MetaDataSuccess), AutomaticSignature data = default(AutomaticSignature))
        {
            this.Meta = meta;
            this.Data = data;
        }
        ...
        public AutomaticSignature Data { get; set; }
