...
namespace SigningToday.Model
{
    ...
    public partial class InlineObject9 :  IEquatable<InlineObject9>, IValidatableObject
    {
        ...
        public InlineObject9(System.IO.Stream file = default(System.IO.Stream))
        {
            // to ensure "file" is required (not null)
            if (file == null)
            {
                throw new InvalidDataException("file is a required property for InlineObject9 and cannot be null");
            }
            else
            {
                this.File = file;
