...
namespace SigningToday.Model
{
    ...
    public partial class InlineObject1 :  IEquatable<InlineObject1>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="reason">This is the actual reason why the Digital Signature Transaction is going to be canceled, to be provided in the body of the request .</param>
        public InlineObject1(string reason = default(string))
        {
            this.Reason = reason;
        }
        ...
        /// </summary>
        /// <value>This is the actual reason why the Digital Signature Transaction is going to be canceled, to be provided in the body of the request </value>
