...
namespace SigningToday.Model
{
    ...
    public partial class InlineObject1 :  IEquatable<InlineObject1>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="text">This is the actual content of the _DSTNote_.</param>
        public InlineObject1(string text = default(string))
        {
            this.Text = text;
        }
        ...
        /// </summary>
        /// <value>This is the actual content of the _DSTNote_</value>
