...
namespace SigningToday.Model
{
    ...
    public partial class Identity :  IEquatable<Identity>, IValidatableObject
    {
        ...
        public Identity(IdentityActions actions = default(IdentityActions), Object providerData = default(Object), string signatureAppearanceUri = default(string))
        {
        ...
        public string ProviderImage { get; private set; }
        ...
        public string SendOtpUrl { get; private set; }
