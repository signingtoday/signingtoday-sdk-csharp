...
namespace SigningToday.Model
{
    ...
    public partial class Token :  IEquatable<Token>, IValidatableObject
    {
        ...
        /// <param name="user">The user whom is associated the Token.</param>
        /// <param name="webhooks">webhooks.</param>
        public Token(CreateTokenHttpOptions httpOptions = default(CreateTokenHttpOptions), string user = default(string), CreateTokenWebhooks webhooks = default(CreateTokenWebhooks))
        {
        ...
        /// <summary>
        /// The user created the Token - _user_name@organization-id_ -
        /// </summary>
        /// <value>The user created the Token - _user_name@organization-id_ -</value>
        ...
        /// </summary>
        /// <value>The uuid code that identifies the Token</value>
        ...
        /// </summary>
        /// <value>The user whom is associated the Token</value>
        ...
        /// </summary>
        /// <value>This is the actual value of the Token, usually in a uuid format</value>
