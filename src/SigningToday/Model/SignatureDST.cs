...
namespace SigningToday.Model
{
    ...
    public partial class SignatureDST :  IEquatable<SignatureDST>, IValidatableObject
    {
        ...
        public SignatureDST(Object constraints = default(Object), bool declinable = default(bool), string description = default(string), string displayName = default(string), ProfileEnum? profile = default(ProfileEnum?), string reason = default(string), string signer = default(string), string urlback = default(string), SignatureDSTWhere where = default(SignatureDSTWhere))
        {
