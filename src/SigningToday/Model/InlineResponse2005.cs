...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        public InlineResponse2005(PaginationData pagination = default(PaginationData), MetaDataSuccess meta = default(MetaDataSuccess), Identity data = default(Identity))
        {
