...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        public InlineResponse2005(List<IdentityEnroll> data = default(List<IdentityEnroll>), MetaDataSuccess meta = default(MetaDataSuccess), PaginationData pagination = default(PaginationData))
        {
            this.Data = data;
            this.Meta = meta;
        ...
        public List<IdentityEnroll> Data { get; set; }
