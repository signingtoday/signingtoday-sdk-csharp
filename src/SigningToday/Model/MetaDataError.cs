...
namespace SigningToday.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MetaDataError :  IEquatable<MetaDataError>, IValidatableObject
    {
        /// <summary>
        ...
        public MetaDataError(int code = default(int), string errorMessage = default(string), string errorType = default(string))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as MetaDataError);
        }

        /// <summary>
        /// Returns true if MetaDataError instances are equal
        /// </summary>
        /// <param name="input">Instance of MetaDataError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetaDataError input)
        {
            if (input == null)
                return false;
