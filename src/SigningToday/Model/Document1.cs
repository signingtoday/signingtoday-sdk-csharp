...
namespace SigningToday.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Document1 :  IEquatable<Document1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Document1" /> class.
        /// </summary>
        ...
        public Document1(string displayName = default(string), string documentUri = default(string), List<List<SignatureDST>> groups = default(List<List<SignatureDST>>))
        {
        ...
        public List<List<SignatureDST>> Groups { get; set; }
        ...
        {
            return this.Equals(input as Document1);
        }

        /// <summary>
        /// Returns true if Document1 instances are equal
        /// </summary>
        /// <param name="input">Instance of Document1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Document1 input)
        {
            if (input == null)
                return false;
