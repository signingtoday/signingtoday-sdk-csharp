...
namespace SigningToday.Model
{
    ...
    public partial class Document1 :  IEquatable<Document1>, IValidatableObject
    {
        ...
        public Document1(string displayName = default(string), string documentUri = default(string), Object documentUriOptions = default(Object), List<List<Signature>> groups = default(List<List<Signature>>))
        {
