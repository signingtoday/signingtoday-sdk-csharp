...
namespace SigningToday.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateTokenWebhooks :  IEquatable<CreateTokenWebhooks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTokenWebhooks" /> class.
        /// </summary>
        /// <param name="dst">The url where to receive notifications about digital signature transaction status.</param>
        /// <param name="identity">The url where to receive notifications about identity status.</param>
        public CreateTokenWebhooks(string dst = default(string), string identity = default(string))
        {
            this.Dst = dst;
        ...
        /// </summary>
        /// <value>The url where to receive notifications about digital signature transaction status</value>
        ...
        /// </summary>
        /// <value>The url where to receive notifications about identity status</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateTokenWebhooks {\n");
        ...
        {
            return this.Equals(input as CreateTokenWebhooks);
        }

        /// <summary>
        /// Returns true if CreateTokenWebhooks instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateTokenWebhooks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateTokenWebhooks input)
        {
            if (input == null)
                return false;
