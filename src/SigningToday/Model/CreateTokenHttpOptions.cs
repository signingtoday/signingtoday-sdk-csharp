...
namespace SigningToday.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateTokenHttpOptions :  IEquatable<CreateTokenHttpOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTokenHttpOptions" /> class.
        /// </summary>
        /// <param name="authMode">The mode of the authentication.</param>
        /// <param name="authPassword">The password for the HTTP basic authentication.</param>
        /// <param name="authUsername">The username for the HTTP basic authentication.</param>
        /// <param name="clientCert">the SSL client certificate.</param>
        /// <param name="clientKey">The SSL client key.</param>
        /// <param name="headers">Key-Value pairs that identifies headers to add to the HTTP request.</param>
        public CreateTokenHttpOptions(string authMode = default(string), string authPassword = default(string), string authUsername = default(string), string clientCert = default(string), string clientKey = default(string), Object headers = default(Object))
        {
        ...
        /// </summary>
        /// <value>The mode of the authentication</value>
        ...
        /// </summary>
        /// <value>The password for the HTTP basic authentication</value>
        ...
        /// </summary>
        /// <value>The username for the HTTP basic authentication</value>
        ...
        /// </summary>
        /// <value>the SSL client certificate</value>
        ...
        /// The SSL client key
        /// </summary>
        /// <value>The SSL client key</value>
        ...
        /// </summary>
        /// <value>Key-Value pairs that identifies headers to add to the HTTP request</value>
        ...
        {
            return this.Equals(input as CreateTokenHttpOptions);
        }

        /// <summary>
        /// Returns true if CreateTokenHttpOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateTokenHttpOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateTokenHttpOptions input)
        {
            if (input == null)
                return false;
