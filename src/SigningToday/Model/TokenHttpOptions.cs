...
namespace SigningToday.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TokenHttpOptions :  IEquatable<TokenHttpOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenHttpOptions" /> class.
        /// </summary>
        ...
        public TokenHttpOptions(Object headers = default(Object), string authUsername = default(string), string authPassword = default(string), string authMode = default(string), string clientKey = default(string), string clientCert = default(string))
        {
        ...
        {
            return this.Equals(input as TokenHttpOptions);
        }

        /// <summary>
        /// Returns true if TokenHttpOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenHttpOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenHttpOptions input)
        {
            if (input == null)
                return false;
