...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        public InlineResponse2002(PaginationData pagination = default(PaginationData), MetaDataSuccess meta = default(MetaDataSuccess), List<Identity> data = default(List<Identity>))
        {
