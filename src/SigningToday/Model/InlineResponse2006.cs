...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        public InlineResponse2006(List<SignatureTransaction> data = default(List<SignatureTransaction>), MetaDataSuccess meta = default(MetaDataSuccess), PaginationData pagination = default(PaginationData))
        {
            this.Data = data;
            this.Meta = meta;
