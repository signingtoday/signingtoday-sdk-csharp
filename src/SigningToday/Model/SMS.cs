...
namespace SigningToday.Model
{
    ...
    public partial class SMS :  IEquatable<SMS>, IValidatableObject
    {
        ...
        public SMS(string birthCountry = default(string), DateTime birthDate = default(DateTime), string email = default(string), string firstName = default(string), string lastName = default(string), string phoneMobile = default(string))
        {
