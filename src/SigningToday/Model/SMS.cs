...
namespace SigningToday.Model
{
    ...
    public partial class SMS :  IEquatable<SMS>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="lastName">Last name of the identity.</param>
        /// <param name="firstName">First name of the identity.</param>
        /// <param name="birthDate">Birthdate of the identity.</param>
        /// <param name="birthCountry">Country of birth of the identity.</param>
        /// <param name="email">Email address associated to the identity.</param>
        /// <param name="phoneMobile">Phone number associated to the identity.</param>
        public SMS(string lastName = default(string), string firstName = default(string), DateTime birthDate = default(DateTime), string birthCountry = default(string), string email = default(string), string phoneMobile = default(string))
        {
        ...
        /// </summary>
        /// <value>Last name of the identity</value>
        ...
        /// </summary>
        /// <value>First name of the identity</value>
        ...
        /// </summary>
        /// <value>Birthdate of the identity</value>
        ...
        /// </summary>
        /// <value>Country of birth of the identity</value>
        ...
        /// </summary>
        /// <value>Email address associated to the identity</value>
        ...
        /// </summary>
        /// <value>Phone number associated to the identity</value>
