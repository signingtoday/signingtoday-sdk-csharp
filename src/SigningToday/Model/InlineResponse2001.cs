...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(PaginationData pagination = default(PaginationData), MetaDataSuccess meta = default(MetaDataSuccess), List<User> data = default(List<User>))
        {
