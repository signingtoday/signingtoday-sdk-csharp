...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(List<Identity> data = default(List<Identity>), MetaDataSuccess meta = default(MetaDataSuccess), PaginationData pagination = default(PaginationData))
        {
            this.Data = data;
            this.Meta = meta;
        ...
        public List<Identity> Data { get; set; }
