...
namespace SigningToday.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginationData :  IEquatable<PaginationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginationData" /> class.
        /// </summary>
        ...
        public PaginationData(int count = default(int), string next = default(string), string previous = default(string), int pages = default(int), int page = default(int))
        {
            this.Count = count;
            this.Next = next;
        ...
        {
            return this.Equals(input as PaginationData);
        }

        /// <summary>
        /// Returns true if PaginationData instances are equal
        /// </summary>
        /// <param name="input">Instance of PaginationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginationData input)
        {
            if (input == null)
                return false;
