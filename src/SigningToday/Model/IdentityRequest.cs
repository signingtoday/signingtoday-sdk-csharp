...
namespace SigningToday.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IdentityRequest :  IEquatable<IdentityRequest>, IValidatableObject
    {
        /// <summary>
        /// The id of the provider will issue the requested identity
        /// </summary>
        /// <value>The id of the provider will issue the requested identity</value>
        ...
        public enum ProviderIdEnum
        {
            ...
            /// <summary>
            /// Enum StApproval for value: st-approval
            /// </summary>
            [EnumMember(Value = "st-approval")]
            StApproval = 2
        ...
        public ProviderIdEnum? ProviderId { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityRequest" /> class.
        /// </summary>
        /// <param name="user">The user is intended to associate the requestd identity.</param>
        /// <param name="providerId">The id of the provider will issue the requested identity.</param>
        ...
        /// <param name="registeredBy">The RAO user that registered the identity.</param>
        public IdentityRequest(string user = default(string), ProviderIdEnum? providerId = default(ProviderIdEnum?), string label = default(string), SMS providerData = default(SMS), string registeredBy = default(string))
        {
            this.User = user;
        ...
        /// </summary>
        /// <value>The user is intended to associate the requestd identity</value>
        ...
        public SMS ProviderData { get; set; }

        /// <summary>
        /// The RAO user that registered the identity
        /// </summary>
        /// <value>The RAO user that registered the identity</value>
        ...
        {
            return this.Equals(input as IdentityRequest);
        }

        /// <summary>
        /// Returns true if IdentityRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityRequest input)
        {
            if (input == null)
                return false;
