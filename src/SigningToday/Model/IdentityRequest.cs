...
namespace SigningToday.Model
{
    ...
    public partial class IdentityRequest :  IEquatable<IdentityRequest>, IValidatableObject
    {
        ...
        public IdentityRequest(string label = default(string), SMS providerData = default(SMS), ProviderIdEnum? providerId = default(ProviderIdEnum?), string registeredBy = default(string), string user = default(string))
        {
            this.Label = label;
