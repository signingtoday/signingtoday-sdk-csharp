...
namespace SigningToday.Model
{
    ...
    public partial class SignatureImplementationResponse :  IEquatable<SignatureImplementationResponse>, IValidatableObject
    {
        ...
        public SignatureImplementationResponse(Certificate certificate = default(Certificate), SignatureImplementationResponseChannel channel = default(SignatureImplementationResponseChannel), string document = default(string), Id dst = default(Id), int group = default(int), Id identity = default(Id), PadesSubfilterEnum? padesSubfilter = default(PadesSubfilterEnum?), int page = default(int), Position position = default(Position), Profile profile = default(Profile), ProviderId providerId = default(ProviderId), Reason reason = default(Reason), Id signature = default(Id), SignatureAppearanceUri signatureAppearanceUri = default(SignatureAppearanceUri), string signatureText = default(string), SigningTimeEnum? signingTime = default(SigningTimeEnum?), Title title = default(Title))
        {
