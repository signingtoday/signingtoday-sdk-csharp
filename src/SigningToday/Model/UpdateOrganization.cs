...
namespace SigningToday.Model
{
    ...
    public partial class UpdateOrganization :  IEquatable<UpdateOrganization>, IValidatableObject
    {
        ...
        public UpdateOrganization(string defaultRao = default(string), int dstDefaultDays = 3, string signatureAppearance = default(string), string name = default(string), string logo = default(string))
        {
