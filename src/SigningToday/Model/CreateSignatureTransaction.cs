...
namespace SigningToday.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateSignatureTransaction :  IEquatable<CreateSignatureTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSignatureTransaction" /> class.
        /// </summary>
        ...
        public CreateSignatureTransaction(string title = default(string), List<Document1> documents = default(List<Document1>))
        {
            this.Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateSignatureTransaction {\n");
        ...
        {
            return this.Equals(input as CreateSignatureTransaction);
        }

        /// <summary>
        /// Returns true if CreateSignatureTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSignatureTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSignatureTransaction input)
        {
            if (input == null)
                return false;
