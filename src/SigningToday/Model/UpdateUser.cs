...
namespace SigningToday.Model
{
    ...
    public partial class UpdateUser :  IEquatable<UpdateUser>, IValidatableObject
    {
        ...
        public UpdateUser(string firstName = default(string), string lastName = default(string), string email = default(string), bool automatic = default(bool), bool rao = default(bool))
        {
