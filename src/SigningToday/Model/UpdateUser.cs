...
namespace SigningToday.Model
{
    ...
    public partial class UpdateUser :  IEquatable<UpdateUser>, IValidatableObject
    {
        ...
        public UpdateUser(bool automatic = default(bool), string email = default(string), string firstName = default(string), string lastName = default(string), bool rao = default(bool))
        {
