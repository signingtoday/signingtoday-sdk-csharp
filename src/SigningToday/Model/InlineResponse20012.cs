...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse20012 :  IEquatable<InlineResponse20012>, IValidatableObject
    {
        ...
        public InlineResponse20012(List<User> data = default(List<User>), MetaDataSuccess meta = default(MetaDataSuccess), PaginationData pagination = default(PaginationData))
        {
            this.Data = data;
            this.Meta = meta;
