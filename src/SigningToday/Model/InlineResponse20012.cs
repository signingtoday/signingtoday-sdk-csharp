...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse20012 :  IEquatable<InlineResponse20012>, IValidatableObject
    {
        ...
        public InlineResponse20012(MetaDataSuccess meta = default(MetaDataSuccess), SignatureImplementationResponse data = default(SignatureImplementationResponse))
        {
            this.Meta = meta;
            this.Data = data;
        }
        ...
        public SignatureImplementationResponse Data { get; set; }
