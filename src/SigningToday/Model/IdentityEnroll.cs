...
namespace SigningToday.Model
{
    ...
    public partial class IdentityEnroll :  IEquatable<IdentityEnroll>, IValidatableObject
    {
        ...
        public IdentityEnroll(IdentityEnrollActions actions = default(IdentityEnrollActions), string enrollTicket = default(string), string label = default(string), string next = default(string), Object providerData = default(Object), string urlback = default(string), string user = default(string))
        {
