...
namespace SigningToday.Model
{
    ...
    public partial class InlineObject4 :  IEquatable<InlineObject4>, IValidatableObject
    {
        ...
        /// <param name="sessionId">This is the id of the session is going to use in order the perform the signature or the signatures.</param>
        public InlineObject4(Id identityId = default(Id), string sessionId = default(string))
        {
        ...
        public Id IdentityId { get; set; }

        /// <summary>
        /// This is the id of the session is going to use in order the perform the signature or the signatures
        /// </summary>
        /// <value>This is the id of the session is going to use in order the perform the signature or the signatures</value>
