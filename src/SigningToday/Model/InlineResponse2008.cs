...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>, IValidatableObject
    {
        ...
        public InlineResponse2008(PaginationData pagination = default(PaginationData), MetaDataSuccess meta = default(MetaDataSuccess), List<SignatureTransaction> data = default(List<SignatureTransaction>))
        {
        ...
        public MetaDataSuccess Meta { get; set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [DataMember(Name="data", EmitDefaultValue=false)]
        public List<SignatureTransaction> Data { get; set; }
