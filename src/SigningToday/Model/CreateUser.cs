...
namespace SigningToday.Model
{
    ...
    public partial class CreateUser :  IEquatable<CreateUser>, IValidatableObject
    {
        ...
        public CreateUser(bool automatic = default(bool), string createdBy = default(string), string email = default(string), string firstName = default(string), Guid id = default(Guid), string lastName = default(string), bool owner = default(bool), bool rao = default(bool))
        {
