...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(PaginationData pagination = default(PaginationData), MetaDataSuccess meta = default(MetaDataSuccess), List<Token> data = default(List<Token>))
        {
