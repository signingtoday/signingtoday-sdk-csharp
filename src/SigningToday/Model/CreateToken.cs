...
namespace SigningToday.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateToken :  IEquatable<CreateToken>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateToken" /> class.
        /// </summary>
        /// <param name="httpOptions">httpOptions.</param>
        /// <param name="label">The label assigned to the Token, that is like the name is associated to it.</param>
        /// <param name="user">The user whom the Token is to be associated.</param>
        /// <param name="webhooks">webhooks.</param>
        public CreateToken(CreateTokenHttpOptions httpOptions = default(CreateTokenHttpOptions), string label = default(string), string user = default(string), CreateTokenWebhooks webhooks = default(CreateTokenWebhooks))
        {
        ...
        /// <summary>
        /// Gets or Sets HttpOptions
        /// </summary>
        [DataMember(Name="http_options", EmitDefaultValue=false)]
        public CreateTokenHttpOptions HttpOptions { get; set; }

        /// <summary>
        /// The label assigned to the Token, that is like the name is associated to it
        /// </summary>
        /// <value>The label assigned to the Token, that is like the name is associated to it</value>
        ...
        /// </summary>
        /// <value>The user whom the Token is to be associated</value>
        ...
        public CreateTokenWebhooks Webhooks { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HttpOptions: ").Append(HttpOptions).Append("\n");
        ...
        {
            return this.Equals(input as CreateToken);
        }

        /// <summary>
        /// Returns true if CreateToken instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateToken to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateToken input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.HttpOptions == input.HttpOptions ||
                    (this.HttpOptions != null &&
                    this.HttpOptions.Equals(input.HttpOptions))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HttpOptions != null)
                    hashCode = hashCode * 59 + this.HttpOptions.GetHashCode();
                if (this.Label != null)
