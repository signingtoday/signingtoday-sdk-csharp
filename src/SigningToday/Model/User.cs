...
namespace SigningToday.Model
{
    ...
    public partial class User :  IEquatable<User>, IValidatableObject
    {
        ...
        /// <param name="type">The _type field_ identifies the permissions the User have.</param>
        ...
        /// <param name="wallet">The wallet of an User identifies its portfolio of identities.</param>
        public User(Guid id = default(Guid), string status = default(string), string type = default(string), string email = default(string), string firstName = default(string), string lastName = default(string), string createdBy = default(string), bool automatic = default(bool), bool owner = default(bool), bool rao = default(bool), List<Identity> wallet = default(List<Identity>))
        {
        ...
        public List<Identity> Wallet { get; set; }
