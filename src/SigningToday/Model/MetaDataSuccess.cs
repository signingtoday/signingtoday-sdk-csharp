...
namespace SigningToday.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MetaDataSuccess :  IEquatable<MetaDataSuccess>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetaDataSuccess" /> class.
        /// </summary>
        /// <param name="code">code.</param>
        public MetaDataSuccess(int code = default(int))
        {
            this.Code = code;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MetaDataSuccess {\n");
        ...
        {
            return this.Equals(input as MetaDataSuccess);
        }

        /// <summary>
        /// Returns true if MetaDataSuccess instances are equal
        /// </summary>
        /// <param name="input">Instance of MetaDataSuccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetaDataSuccess input)
        {
            if (input == null)
                return false;
