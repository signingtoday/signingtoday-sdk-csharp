...
namespace SigningToday.Model
{
    ...
    public partial class InlineObject5 :  IEquatable<InlineObject5>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="reason">This is the actual reason for the annulment of the Signature, to be provided in the body of the request .</param>
        public InlineObject5(string reason = default(string))
        {
            this.Reason = reason;
        }
        ...
        /// </summary>
        /// <value>This is the actual reason for the annulment of the Signature, to be provided in the body of the request </value>
