...
namespace SigningToday.Model
{
    ...
    public partial class InlineResponse401 :  IEquatable<InlineResponse401>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="detail">detail (default to &quot;Invalid credentials&quot;).</param>
        public InlineResponse401(string detail = "Invalid credentials")
        {
            // use default value if no "detail" provided
            if (detail == null)
            {
                this.Detail = "Invalid credentials";
            }
            else
            {
                this.Detail = detail;
