...
namespace Example
{
    public class UserIdDeleteExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UsersApi.UserIdDelete: " + e.Message );
...
namespace Example
{
    public class UserIdGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UsersApi.UserIdGet: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class UserIdIdentitiesGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UsersApi.UserIdIdentitiesGet: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class UserIdPutExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UsersApi.UserIdPut: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class UserIdRolePutExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UsersApi.UserIdRolePut: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class UsersGroupsGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UsersApi.UsersGroupsGet: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class UsersGroupsPostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UsersApi.UsersGroupsPost: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
