...
${nuget_cmd} install src/SigningToday/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/SigningToday.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/SigningToday.dll \
-recurse:'src/SigningToday/*.cs' \
-doc:bin/SigningToday.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/SigningToday.dll was created successfully"
fi
